...
python vww_train.py -l models/akidanet_vww_untrained.h5 -s models/akidanet_vww.h5 -e 20 -lr 1e-3 $DATA_ARG
...
python vww_train.py -l models/akidanet_vww_iq8_wq4_aq4.h5 -s models/akidanet_vww_qat.h5 -lr 1e-4 -e 5 $DATA_ARG
