...
"""
PlantVillage per-layer hardware benchmark.

Runs a per-layer timing benchmark on an Akida PlantVillage model, prints a summary
table, saves results as CSV, and generates a summary plot.

Example
-------
    python plant_village_benchmark.py -l akidanet_plant_village_qat.fbz
"""
import argparse
import json
import pathlib
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Per-layer hardware benchmark for an Akida PlantVillage model')
